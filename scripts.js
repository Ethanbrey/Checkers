...
let bluePieces = document.querySelectorAll("span")
...
function resetBorders() {
  for (let i = 0; i < playerPieces.length; i++) {
    playerPieces[i].style.border = "1px solid black";
  }
...
function checkForWin() {
  if (blueScore === 0) {
    ...
    for (let i = 0; i < whiteTurnText.length; ii++) {
      whiteTurnText[i].style.color = "blue";
